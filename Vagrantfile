...
Vagrant.configure("2") do |config|
  # The Zulip development environment runs on 9981 on the guest.
  host_port = 9981
  ...
  config.vm.network "forwarded_port", guest: 9981, host: host_port, host_ip: host_ip_addr
  config.vm.network "forwarded_port", guest: 9984, host: host_port + 3, host_ip: host_ip_addr
